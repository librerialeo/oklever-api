...
func (db *Database) UpdateUserExpertise(expertiseID int32, name string, months int32) (pgx.Rows, error) {
...
func (db *Database) DeleteUserExpertise(expertiseID int32) (pgx.Rows, error) {
	return db.conn.Query(context.Background(), "DELETE FROM users_expertise WHERE user_expertise_id=$1", expertiseID)
}
